...
class EvolutionClientWrapper:
    ...
    def send_text_message(self, remote_jid: str, text: str) -> Dict[str, Any]:
        ...
        """
        try:
            # Criar objeto TextMessage
            message = TextMessage(number=remote_jid, text=text)
    ...
    def check_connection_status(self) -> Dict[str, Any]:
        ...
        try:
            ...
            instances = self.client.instances.fetch_instances()
            
            # Encontrar nossa instância específica
            instance_info = None
            for instance_data in instances:
                instance = instance_data.get("instance", {})
                if instance.get("instanceName") == self.instance_id:
            ...
            state = instance_info.get("status", "unknown")
    ...
    def get_qr_code(self) -> Optional[Dict[str, Any]]:
        ...
        try:
            ...
            # qr_data = self.client.instance_operations.get_qr_code(
            #     instance_id=self.instance_id,
            #     instance_token=self.instance_token
            # )
            
            print("Método get_qr_code não implementado ainda")
            return None
